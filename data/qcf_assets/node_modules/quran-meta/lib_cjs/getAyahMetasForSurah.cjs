...
*/
function getAyahMetasForSurah(surahNumber, data) {
	require_validation.checkValidSurah(surahNumber, data.meta);
	...
	const result = [];
	let meta = require_getAyahMeta.getAyahMeta(startAyahId, data);
	result.push(meta);
