...
//#region src/getThumunAlHizbMeta.ts
/**
...
*/
function getThumunAlHizbMeta(eighthIndex, data) {
	const res = require_getThumunAlHizb.getThumunAlHizb(eighthIndex);
	...
	const [firstAyahId, nextJuzAyahId] = [HizbEighthList[eighthIndex], HizbEighthList[eighthIndex + 1]];
...
//#endregion
exports.getThumunAlHizbMeta = getThumunAlHizbMeta;