...
*/
function isValidAyahId(x, meta) {
	return Number.isInteger(x) && x >= 1 && x <= meta.numAyahs;
}
/**
...
function isValidAyahNo(x) {
	return Number.isInteger(x) && x >= 1 && x <= require_types.maxAyahsInSurah;
}
/**
...
*/
function isValidSurah(x, meta) {
	return Number.isInteger(x) && x >= 1 && x <= meta.numSurahs;
}
/**
...
* ```
*/
function isValidSurahAyah(x, data) {
	const [surah, ayah] = x;
	if (!isValidSurah(surah, data.meta)) return false;
	return Number.isInteger(ayah) && ayah >= 1 && ayah <= require_getAyahCountInSurah.getAyahCountInSurah(surah, data);
}
/**
...
*/
function isValidJuz(x, meta) {
	return Number.isInteger(x) && x >= 1 && x <= meta.numJuzs;
}
/**
...
*/
function isValidPage(x, meta) {
	return Number.isInteger(x) && x >= 1 && x <= meta.numPages;
}
/**
...
* ```
*/
function isValidRuku(x, meta) {
	return Number.isInteger(x) && x >= 1 && x <= meta.numRukus;
}
/**
...
* ```
*/
function isValidManzil(x, meta) {
	return Number.isInteger(x) && x >= 1 && x <= meta.numManzils;
}
