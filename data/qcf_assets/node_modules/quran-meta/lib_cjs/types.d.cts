import { FixedArray, LessThan } from "./ts-utils.cjs";
import { RiwayaName } from "./lists/types.cjs";
...
interface SurahAyahPos {
  surah: Surah;
  ayah: AyahNo;
}
interface AyahMeta extends SurahAyahPos {
  juz: Juz;
  juzPart: JuzPart;
  hizbId: HizbId;
  rubAlHizbId: RubAlHizbId;
...
//#endregion
export { AyahCountBetweenJuzSurah, AyahId, AyahMeta, AyahNo, AyahRange, HizbId, Juz, JuzMeta, JuzPart, Manzil, ManzilMeta, Page, PageMeta, QuranMeta, RangeMeta, RangeMode, RubAlHizb, RubAlHizbId, RubAlHizbMeta, Ruku, RukuMeta, Surah, SurahAyah, SurahAyahPos, SurahAyahSegment, SurahInfo, SurahJuzMeta, SurahListType, SurahMeta, SurahName, ThumunAlHizb, ThumunAlHizbId, ThumunAlHizbMeta };