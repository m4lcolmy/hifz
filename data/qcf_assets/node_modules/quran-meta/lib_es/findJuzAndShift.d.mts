...
import { AyahCountBetweenJuzSurah, AyahId, AyahNo, Juz, Surah } from "./types.mjs";
 ...
 */
declare function findJuzAndShift(surah: Surah, ayah: AyahNo, lists: RiwayaData): {
  juz: Juz;
  leftAyahId: AyahId;
 ...
 */
declare function findJuzAndShiftByAyahId(ayahId: AyahId, data: RiwayaData): {
  juz: Juz;
  leftAyahId: AyahId;
  ayahsBetweenJuzSurah: AyahCountBetweenJuzSurah;
};
