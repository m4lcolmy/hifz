...
class MushafView(QGraphicsView):
    ...
    JSON file generated by tarteel/scripts/generate_masks.py using OpenCV.
    """
    ...
    @classmethod
    def _load_mask_coords(cls, dataset_dir: str) -> dict:
        ...
        coords_path = os.path.join(dataset_dir, "Quran_pages_mask_coords.json")
        if not os.path.exists(coords_path):
            print(f"ERROR: Mask coordinates file not found: {coords_path}")
            print("Please run: python tarteel/scripts/generate_masks.py")
            return {}
    ...
    def load_dataset_page(self, dataset_dir: str, page_num: int):
        ...
        mask_coords = self._load_mask_coords(dataset_dir)
        ...
        # We still need the text file for the token strings (the JSON only has coordinates)
        flat_tokens = []
